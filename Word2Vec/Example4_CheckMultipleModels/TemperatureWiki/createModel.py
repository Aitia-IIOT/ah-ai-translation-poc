...
text_file_path = 'preprocessed_inputText2_TemperatureWikipedia.txt'
...
model.save("word2vec_TemperatureWiki.model")

# Step 3: Use the model for context recognition
# Loading the model from disk
model = Word2Vec.load("word2vec_TemperatureWiki.model")
